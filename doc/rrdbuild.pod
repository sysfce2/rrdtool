...
Once you have decided. Save the two locations into environment variables.
 ...
 INSTALL_DIR=/opt/rrdtool-1.10.1
...
pre-installed.
 ...
 wget https://github.com/oetiker/rrdtool-1.x/releases/download/v1.10.1/rrdtool-1.10.1.tar.gz
 gunzip -c rrdtool-1.10.1.tar.gz | tar xf -
 cd rrdtool-1.10.1
